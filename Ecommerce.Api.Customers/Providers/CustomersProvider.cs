...
namespace Ecommerce.Api.Customers.Providers
{
    ...
    public class CustomersProvider : ICustomersProvider
    {
        ...
        public async Task<(bool IsSuccess, IEnumerable<Models.Customers> Customers, string ErrorMessage)> GetCustomersAsync()
        {
            try
            {
                ...
                if (customers != null && customers.Any())
                {
                    ...
                    var result = mapper.Map<IEnumerable<Db.Customer>, IEnumerable<Models.Customers>>(customers);
        ...
        public async Task<(bool IsSuccess, Models.Customers Customer, string ErrorMessage)> GetCustomerAsync(int id)
        {
            try
            {
                logger?.LogInformation("Querying customers");
                ...
                if (customer != null)
                {
                    ...
                    var result = mapper.Map<Db.Customer, Models.Customers>(customer);
                    return (true, result, null);
                }
                return (false, null, "Not found");
            }
